...
- A round has no time limit and no cancel. To stop one, kill the pid in `../<repo>.specialists/.state/<run>/pid`; the mod then reports the round as stopped before it finished.
