...
- Connection status (connected, timeout, auth error, inference blocked, rate limited, not configured), and "inference unverified" after the model when the chat probe got an answer it did not recognise
